	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 tex2DNode74 = tex2D( _MetallicSmoothness, uv_MetallicSmoothness );
				
				float2 uv_LoopTex = packedInput.ase_texcoord5.xy * _LoopTex_ST.xy + _LoopTex_ST.zw;
				float2 panner13_g55 = ( 1.0 * _Time.y * _LoopTexPanSpeed + uv_LoopTex);
				float4 LoopTex33_g55 = ( tex2D( _LoopTex, panner13_g55 ) * _LoopTexMult );
				float2 uv_MaskTex = packedInput.ase_texcoord5.xy * _MaskTex_ST.xy + _MaskTex_ST.zw;
				float4 tex2DNode4_g55 = tex2D( _MaskTex, uv_MaskTex );
				float4 _Vector2 = float4(15,1,0,0);
				float2 uv_BurnoutMask = packedInput.ase_texcoord5.xy * _BurnoutMask_ST.xy + _BurnoutMask_ST.zw;
				float dotResult63_g55 = dot( tex2D( _BurnoutMask, uv_BurnoutMask ) , float4( float3(0.22,0.707,0.071) , 0.0 ) );
				...
				float3 tanNormal28_g55 = tex2DNode13;
				float3 worldNormal28_g55 = normalize( float3(dot(tanToWorld0,tanNormal28_g55), dot(tanToWorld1,tanNormal28_g55), dot(tanToWorld2,tanNormal28_g55)) );
				float fresnelNdotV22_g55 = dot( normalize( worldNormal28_g55 ), V );
				float fresnelNode22_g55 = ( _FresnelBias + _FresnelScale * pow( max( 1.0 - fresnelNdotV22_g55 , 0.0001 ), _FresnelExp ) );
				float Fresnel31_g55 = saturate( fresnelNode22_g55 );
				float2 temp_output_39_0_g55 = ( float2( 0,1.2 ) - ( ( float2( 0,1 ) * _Burnout ) + Fresnel31_g55 ) );
				float4 wipe49_g55 = tex2D( _WipeEm, temp_output_39_0_g55 );
				
				float4 tex2DNode2_g55 = tex2D( _WipeOp, ( 1.0 - ( temp_output_39_0_g55 + _BurnUVOffset ) ) );
				float wipeMask56_g55 = ( tex2DNode2_g55.r * tex2DNode4_g55.r );
				
				surfaceDescription.BaseColor = tex2D( _Albedo, uv_Albedo ).rgb;
				surfaceDescription.Normal = tex2DNode13;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = ( _Metallic * tex2DNode74.r );

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = 0;
				#endif

				surfaceDescription.Emission = ( ( ( LoopTex33_g55 * ( tex2DNode4_g55.g * _Vector2 ) ) + ( tex2DNode4_g55.b * _Vector2 ) + ( dotResult63_g55 * wipe49_g55 * _BurnColor * ( _BurnColor.a * 300.0 ) ) ) * _EmissiveBoost ).rgb;
				surfaceDescription.Smoothness = ( tex2DNode74.a * _Smoothness );
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = wipeMask56_g55;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_LoopTex = packedInput.ase_texcoord2.xy * _LoopTex_ST.xy + _LoopTex_ST.zw;
				float2 panner13_g55 = ( 1.0 * _Time.y * _LoopTexPanSpeed + uv_LoopTex);
				float4 LoopTex33_g55 = ( tex2D( _LoopTex, panner13_g55 ) * _LoopTexMult );
				float2 uv_MaskTex = packedInput.ase_texcoord2.xy * _MaskTex_ST.xy + _MaskTex_ST.zw;
				float4 tex2DNode4_g55 = tex2D( _MaskTex, uv_MaskTex );
				float4 _Vector2 = float4(15,1,0,0);
				float2 uv_BurnoutMask = packedInput.ase_texcoord2.xy * _BurnoutMask_ST.xy + _BurnoutMask_ST.zw;
				float dotResult63_g55 = dot( tex2D( _BurnoutMask, uv_BurnoutMask ) , float4( float3(0.22,0.707,0.071) , 0.0 ) );
				...
				float3 tanNormal28_g55 = tex2DNode13;
				float3 worldNormal28_g55 = normalize( float3(dot(tanToWorld0,tanNormal28_g55), dot(tanToWorld1,tanNormal28_g55), dot(tanToWorld2,tanNormal28_g55)) );
				float fresnelNdotV22_g55 = dot( normalize( worldNormal28_g55 ), ase_worldViewDir );
				float fresnelNode22_g55 = ( _FresnelBias + _FresnelScale * pow( max( 1.0 - fresnelNdotV22_g55 , 0.0001 ), _FresnelExp ) );
				float Fresnel31_g55 = saturate( fresnelNode22_g55 );
				float2 temp_output_39_0_g55 = ( float2( 0,1.2 ) - ( ( float2( 0,1 ) * _Burnout ) + Fresnel31_g55 ) );
				float4 wipe49_g55 = tex2D( _WipeEm, temp_output_39_0_g55 );
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 temp_output_39_0_g55 = ( float2( 0,1.2 ) - ( ( float2( 0,1 ) * _Burnout ) + Fresnel31_g55 ) );
				float4 tex2DNode2_g55 = tex2D( _WipeOp, ( 1.0 - ( temp_output_39_0_g55 + _BurnUVOffset ) ) );
				float2 uv_MaskTex = packedInput.ase_texcoord1.xy * _MaskTex_ST.xy + _MaskTex_ST.zw;
				float4 tex2DNode4_g55 = tex2D( _MaskTex, uv_MaskTex );
				float wipeMask56_g55 = ( tex2DNode2_g55.r * tex2DNode4_g55.r );
		...
		Pass
		{
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float2 temp_output_39_0_g55 = ( float2( 0,1.2 ) - ( ( float2( 0,1 ) * _Burnout ) + Fresnel31_g55 ) );
				float4 tex2DNode2_g55 = tex2D( _WipeOp, ( 1.0 - ( temp_output_39_0_g55 + _BurnUVOffset ) ) );
				float2 uv_MaskTex = packedInput.ase_texcoord3.xy * _MaskTex_ST.xy + _MaskTex_ST.zw;
				float4 tex2DNode4_g55 = tex2D( _MaskTex, uv_MaskTex );
				float wipeMask56_g55 = ( tex2DNode2_g55.r * tex2DNode4_g55.r );
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_LoopTex = packedInput.ase_texcoord7.xy * _LoopTex_ST.xy + _LoopTex_ST.zw;
				float2 panner13_g55 = ( 1.0 * _Time.y * _LoopTexPanSpeed + uv_LoopTex);
				float4 LoopTex33_g55 = ( tex2D( _LoopTex, panner13_g55 ) * _LoopTexMult );
				float2 uv_MaskTex = packedInput.ase_texcoord7.xy * _MaskTex_ST.xy + _MaskTex_ST.zw;
				float4 tex2DNode4_g55 = tex2D( _MaskTex, uv_MaskTex );
				float4 _Vector2 = float4(15,1,0,0);
				float2 uv_BurnoutMask = packedInput.ase_texcoord7.xy * _BurnoutMask_ST.xy + _BurnoutMask_ST.zw;
				float dotResult63_g55 = dot( tex2D( _BurnoutMask, uv_BurnoutMask ) , float4( float3(0.22,0.707,0.071) , 0.0 ) );
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.RangedFloatNode;45;-448.3327,-518.5889;Float;False;Property;_NormalScale;NormalScale;2;0;Create;True;0;0;0;False;0;False;1;-0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;15;168.9829,-983.9171;Float;False;Property;_Smoothness;Smoothness;4;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;74;68.15033,-1229.665;Inherit;True;Property;_MetallicSmoothness;MetallicSmoothness;20;0;Create;True;0;0;0;False;0;False;-1;None;ebd243519cdc7d441bc85b2600949e88;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;87;146.6016,-524.7086;Inherit;False;F3DBurnout;5;;55;87cfee5b5269ad846b54547661f27860;0;1;24;FLOAT3;0,0,0;False;2;COLOR;11;FLOAT;12
Node;AmplifyShaderEditor.RangedFloatNode;14;501.9829,-1207.917;Float;False;Property;_Metallic;Metallic;3;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;72;216.1503,-422.665;Inherit;False;Property;_EmissiveBoost;Emissive Boost;21;0;Create;True;0;0;0;False;0;False;1;129.53;0;0;0;1;FLOAT;0
...
WireConnection;61;1;13;0
WireConnection;61;4;75;0
WireConnection;61;6;73;0
WireConnection;61;7;76;0
WireConnection;61;9;87;12
ASEEND*/
//CHKSM=71F91851B037A104198B6232D5C8106A7FF69C7A