	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.BaseColor = ( _TintRGBAmbientAMult * tex2D( _Color, uv_Color ) ).rgb;
				...
				surfaceDescription.Alpha = ( smoothstepResult13_g2 - smoothstepResult25_g2 );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_Color = packedInput.ase_texcoord2.xy * _Color_ST.xy + _Color_ST.zw;
...
Node;AmplifyShaderEditor.ColorNode;13;-1005.829,-333.037;Float;False;Property;_TintRGBAmbientAMult;Tint [RGB:Ambient, A:Mult];5;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;6;-745.8289,496.963;Float;False;Property;_FadeInAInBOutAOutB;Fade[InA,InB,OutA,OutB];4;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,5,25.16,56.2;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;17;4;11;0
WireConnection;17;7;12;0
WireConnection;17;9;7;18
ASEEND*/
//CHKSM=DA44EBF47DBC7AF14E1F6536F31F2D6379F95572